...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().pincode(DEFAULT_PINCODE).country(DEFAULT_COUNTRY).state(DEFAULT_STATE).city(DEFAULT_CITY);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().pincode(UPDATED_PINCODE).country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
        return location;
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.pincode(UPDATED_PINCODE).country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.pincode(UPDATED_PINCODE).state(UPDATED_STATE).city(UPDATED_CITY);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.pincode(UPDATED_PINCODE).country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
