...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKILLSMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKILLSMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKILLSMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKILLSMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKILLSMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKILLSMASTER actions', async () => {
      const expectedActions = [
        {
