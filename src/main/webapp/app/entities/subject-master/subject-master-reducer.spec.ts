...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBJECTMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBJECTMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBJECTMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBJECTMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBJECTMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBJECTMASTER actions', async () => {
      const expectedActions = [
        {
