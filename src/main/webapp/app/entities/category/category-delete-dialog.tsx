...
export const CategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplifyMarketplaceApp.category.delete.question">
        <Translate contentKey="simplifyMarketplaceApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
