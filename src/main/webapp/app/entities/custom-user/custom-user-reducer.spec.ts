...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMUSER actions', async () => {
      const expectedActions = [
        {
