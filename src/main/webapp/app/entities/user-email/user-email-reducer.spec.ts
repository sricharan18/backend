...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREMAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREMAIL actions', async () => {
      const expectedActions = [
        {
