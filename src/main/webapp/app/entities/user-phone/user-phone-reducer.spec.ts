...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPHONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERPHONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERPHONE actions', async () => {
      const expectedActions = [
        {
