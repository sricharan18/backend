...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplifyMarketplaceApp.location.delete.question">
        <Translate contentKey="simplifyMarketplaceApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
