...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDVALUE actions', async () => {
      const expectedActions = [
        {
