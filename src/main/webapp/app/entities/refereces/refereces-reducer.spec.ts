...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './refereces.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFERECES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFERECES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFERECES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFERECES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFERECES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFERECES actions', async () => {
      const expectedActions = [
        {
