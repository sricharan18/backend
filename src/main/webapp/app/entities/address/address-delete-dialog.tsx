...
export const AddressDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplifyMarketplaceApp.address.delete.question">
        <Translate contentKey="simplifyMarketplaceApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
